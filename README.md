...
# ytdl [![Build Status](https://travis-ci.org/otium/ytdl.svg?branch=dev)](https://travis-ci.org/otium/ytdl) [![GoDoc](https://godoc.org/github.com/codegangsta/cli?status.svg)](https://godoc.org/github.com/otium/ytdl)
------
